...
namespace UndergroundIRO.ProxyManager.HidemyParser.Exceptions
{
    public class HidemyParseException : Exception
    {
        /// <summary>Initializes a new instance of the <see cref="T:System.Exception"></see> class.</summary>
        public HidemyParseException()
        {
        }
        ...
        protected HidemyParseException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        public HidemyParseException(string message) : base(message)
        {
        }
        ...
        public HidemyParseException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}
